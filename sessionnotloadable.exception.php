 ...
 */
class SessionNotLoadableException extends XYException
{
    ...
    {
        return 'SessionNotLoadableException in file '.$this->aTrace[0]['File']
            .' at line '.$this->aTrace[0]['Line'];
    }

    protected function GetMailBody()
    {
        $sResult = 'SessionNotLoadableException in file '.$this->aTrace[0]['File']
            .' at line '.$this->aTrace[0]['Line']."\n";
        $sResult.= "\nTrace:\n";
